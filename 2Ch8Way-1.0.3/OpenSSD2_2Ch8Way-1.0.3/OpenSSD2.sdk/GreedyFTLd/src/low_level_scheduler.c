...
//execute low level requests per channel
int ExeLowLevelReqPerCh(int chNo, int firstQueue)
{
	//TODO a. understand what each of these registers represent in abstract level
	//     b. find where this lies in hardware block design
	//     c. print everything with a new log file (consistent print)
	//     d. unit tests?
	//     e. asdf
	...
	{
		//xil_printf("\r\n idleHead status not equal to 0xf");
	...
	{
		//xil_printf("\r\n status report head not equal to 0xf");
	...
	{
		//xil_printf("nvme dma head is not equal to 0xf");

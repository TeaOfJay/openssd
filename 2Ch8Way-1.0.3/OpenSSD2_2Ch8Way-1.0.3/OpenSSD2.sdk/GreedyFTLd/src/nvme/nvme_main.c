...
void nvme_main()
{
	...
	xil_printf("LRU Buffer initialization \r\n");
	LRUBufInit();
	xil_printf("Initialize channel control registers...\r\n");
	InitChCtlReg();
	xil_printf("Initialize die request queue...\r\n");
	InitDieReqQueue();
	xil_printf("Initialize die status table...\r\n");
	InitDieStatusTable();
	xil_printf("Initialize nand reset...\r\n");
	InitNandReset();

	xil_printf("Initialize empty low level queue...\r\n");
	EmptyLowLevelQ(SUB_REQ_QUEUE);
	xil_printf("Initialize FTL map table \r\n");
